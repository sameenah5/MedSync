...
export function PendingPayouts({ payouts }) {
  ...
  // Fix ESLint warning: defer state updates in useEffect
  useEffect(() => {
    if (data?.success) {
      setTimeout(() => {
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-white">Dr. {selectedPayout.doctor.name}</p>
                  </div>
                  <div>
              ...
              {selectedPayout.doctor.credits < selectedPayout.credits && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Warning: Doctor currently has only {selectedPayout.doctor.credits} credits but this payout requires {selectedPayout.credits} credits. The payout cannot be processed.
                  </AlertDescription>
                </Alert>
              )}
            </div>
            ...
            <div className="space-y-4 py-4">
              <Alert>
                ...
                <AlertDescription>
                  ...
                  <ul className="mt-2 space-y-1 list-disc pl-4">
                    <li>
                      Deduct {selectedPayout.credits} credits from Dr. {selectedPayout.doctor.name}&apos; account
                    </li>
              ...
              <div className="bg-muted/20 p-4 rounded-lg border border-emerald-900/20">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-emerald-400 font-medium">${selectedPayout.netAmount.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
