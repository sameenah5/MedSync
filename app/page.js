            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
               <div className="space-y-8">
                 <Badge variant="outline"
                   className="bg-emerald-900/30 text-emerald-400 border-emerald-700/30 px-4 py-2 text-sm font-medium">
                   Your Health, Simplified. Your Life, Streamlined
                  </Badge>
                  <h1 className="text-4xl  md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                    Seamlessly Manage Your Health,<br /> 
                    <span className="text-emerald-400 font-bold">Anytime, Anywhere.</span>
                  </h1>
                ...
                <div className="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden">
                  ...
                  fill
                  priority
                  className="object-cover object-[center_40%] rounded-xl"
